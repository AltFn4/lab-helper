<x-app-layout>
    <form action="{{ route('request.create') }}">
        @csrf
        @method('POST')
        <div class="p-5 grid grid-cols-2 gap-5 text-white">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="request-type" id="request-type" class="bg-gray-800 rounded" required>
                        <option value=""></option>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea name="request-desc" id="request-desc" cols="30" rows="5" class="bg-gray-800 rounded" placeholder="Describe the context of the request..."></textarea>
                </div>
