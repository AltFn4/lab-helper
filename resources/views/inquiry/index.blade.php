<x-app-layout>
    <div class="p-5 m-5 text-white">
        ...
        <div>
            <table class="border-4 border-gray-800 w-full table-fixed">
                <tr class="bg-gray-500 border-2 border-gray-800">
                    <th class="border-2 border-gray-800">desc</th>
                    <th class="border-2 border-gray-800">name</th>
                    <th class="border-2 border-gray-800">type</th>
                    <th class="border-2 border-gray-800">time elapsed</th>
                    <th></th>
                </tr>

                @foreach($inquiries as $inquiry)
                <tr class="border-2 border-gray-800 hover:bg-gray-600">
                    <td class="border-2 border-gray-800 truncate">{{ $inquiry->desc }}</td>
                    <td class="border-2 border-gray-800">{{ $inquiry->student->name }}</td>
                    ...
                    <td>
                        <a href="{{ route('inquiry.show', ['inquiry_id' => $inquiry->id]) }}">Inspect</a>
                    </td>
                </tr>
                @endforeach
            </table>
